  ...
  if (nuevoCliente) {
    ...
    for (int i = 0; i < MAX_CLIENTES; i++) {
      if (!clientes[i] || !clientes[i].connected()) {
        ...
        // Nivel 1 - reducir latencia: desactiva el algoritmo de Nagle,
        // para que comandos cortos como "ON"/"OFF" salgan de inmediato
        // en vez de esperar a juntarse con más datos.
